...
Having satisfied ourselves that the priors mostly make sense, we now fit the model to simulated data generated from known parameter values. The goal here is to ensure that the model recovers the true underlying parameters.


##  Simulated data and modeling
